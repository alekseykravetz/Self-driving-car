...
| Module                       | Responsibility                                                                                                                                                                                                                    |
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `config.ts`                  | Default car configuration (`maxSpeed`, `acceleration`, etc.); `PhysicsModel` type (`'arcade' \| 'realistic'`) and its tuning constants (`REALISTIC_STEER_RATE`, `REALISTIC_BRAKE_FORCE_RATIO`, `REALISTIC_ENGINE_TAPER_EXPONENT`) |
