...
- 206 files · ~207,562 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 2595 nodes · 5347 edges · 149 communities (127 shown, 22 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `a7642758`
...
- `TrainingInitDefaults` --references--> `CarInfo` [EXTRACTED]
  ts/simulator/training/trainingInitModal.ts → ts/car/car.ts
- `TaggedHit` --references--> `TrafficControlState` [EXTRACTED]
  ts/car/physics/sensorRaycaster.ts → ts/math/trafficControlGrid.ts
...
Cohesion: 0.09
Nodes (24): lerp(), mulberry32(), translate(), IMiniMapCar, drawEnvelope(), drawPolygon(), PolygonDrawOptions, Corridor (+16 more)

### Community 1 - "entry.ts"

Cohesion: 0.15
Nodes (15): ArrowDir, ConnectionEdge, Hover, NetworkLayout, NeuronNode, BorderMode, WORLD_LAYER_BUTTONS, PointDrawOptions (+7 more)

### Community 2 - "world.ts"

Cohesion: 0.13
Nodes (11): Viewport, ViewportMode, CrossingEditor, MarkingEditor, ParkingEditor, StartEditor, StopEditor, TargetEditor (+3 more)

### Community 3 - "raceSimulator.js"

Cohesion: 0.13
Nodes (16): Brain, BrainControlOutput, CarCallbacks, CarOptions, DEFAULT_CAR_CONFIG, DEFAULT_HIDDEN_LAYERS, Controls, ControlType (+8 more)

### Community 4 - "utils.js"

Cohesion: 0.17
Nodes (8): NeuralNetwork, applyPoolToCars(), brainsCompatible(), createCarsForTraining(), getSortedAICars(), getTopAICars(), getTopCarInfoPool(), inferHiddenLayers()
...
Cohesion: 0.12
Nodes (24): ShortestPathPoint, add(), angle(), dot(), formatDegrees(), getFake3dPoint(), getNearestPoint(), lerp2D() (+16 more)

### Community 8 - "StoreManager"

Cohesion: 0.05
Nodes (18): ToolbarAssetSelectors, SM_TRACKED_LS_KEYS, smGenId(), smNormalizeWorldId(), smPersist(), smWorldMarkers(), StoreManager, spFormatHiddenLayers() (+10 more)

### Community 9 - "point.js"

Cohesion: 0.48
Nodes (4): TaggedHit, nearestEdgeOffset(), polysIntersect(), getIntersectionOffset()
...
Cohesion: 0.05
Nodes (13): Marker, PointWithBlueness, Graph, ParsedRoads, Point, Segment, TrafficControlHit, getNearestSegment() (+5 more)
...
Cohesion: 0.06
Nodes (5): ToolbarModeControls, ToolbarViewportMode, TrackingMode, WorldToolbarElement, RacePanel
...
Cohesion: 0.08
Nodes (25): Camera, extrudeCarShape(), extrudePolygons(), extrudeTreeShapes(), getCentroid(), movePointsInward(), ICameraPoint, ICameraRenderOptions (+17 more)
...
Cohesion: 0.13
Nodes (5): CYCLE_ORDER, LightEditor, Light, LightState, TrafficManager

### Community 30 - "RaceSimulator"

Cohesion: 0.18
Nodes (6): beep(), explode(), SoundEngine, taDaa(), CarControls, RaceSimulator

### Community 31 - "carBrainAdapter.ts"

Cohesion: 0.14
Nodes (6): IntersectionPoint, SensorRaycaster, encodeTrafficState(), Sensor, SensorReading, Level

### Community 32 - "CarInfo"

Cohesion: 0.14
Nodes (15): getRandomColor(), getRGBA(), loadSimLayerVisibility(), loadRaceCars(), trafficCarOptions(), TrainingInitDefaults, safeJsonParse(), stripFileExtension() (+7 more)
...
Cohesion: 0.16
Nodes (16): PhoneControls, SensorTrafficControl, ObstacleType, GridSegment, TrafficControlEntry, TrafficControlState, MiniMap, MiniMapDrawOptions (+8 more)
...
Cohesion: 0.05
Nodes (7): CarBrainAdapter, SpatialHashGrid, TrafficControlGrid, HumanBackpropSimulator, TrafficSimulator, generateInitialTraffic(), WorldTrainingStrategy
...
Cohesion: 0.22
Nodes (9): Osm, OsmData, OsmElement, OsmNodeElement, OsmPoint, OsmWayElement, OsmWayTags, degToRad() (+1 more)
...
Cohesion: 0.16
Nodes (5): boundsOverlap(), computePolygonBounds(), wgGenerateLaneGuides(), wgGenerateSeparatorBorders(), WorldGenerator

### Community 87 - "CameraControls"

Cohesion: 0.09
Nodes (4): Car, CarDrawData, TrafficPanelElement, TrainingManagerOptions
...
Cohesion: 0.18
Nodes (8): CarInfo, CarLoader, compareCarInfoParams(), normalizeStateAware(), parseCarFileContent(), HumanTrainingConfigResult, savePoolToStorage(), TrainingInitResult
...
- **1152 isolated node(s):** `$schema`, `default_agent`, `.opencode/skills`, `model`, `.opencode/plugins/graphify.js` (+1147 more)
...
- **Why does `Point` connect `Segment` to `entry.js`, `entry.ts`, `world.ts`, `raceSimulator.js`, `world.js`, `Point`, `point.js`, `GraphEditor`, `worldGenerator.ts`, `Light`, `RaceSimulator`, `carBrainAdapter.ts`, `CorridorEditor`, `TrainingSimulator`, `trafficSimulator.ts`, `utils.ts`, `CameraControls`, `osm.ts`, `carPhysics.ts`, `WorldGenerator`, `CameraControls`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `StoreManager` connect `StoreManager` to `CarInfo`, `entry.ts`, `world.ts`, `raceSimulator.js`, `utils.js`, `world.js`, `trafficSimulator.ts`, `CarInfo`, `utils.ts`, `WorldEditor`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `SimulatorShell` connect `SimulatorShell` to `entry.ts`, `world.ts`, `raceSimulator.js`, `TrainingSimulator`, `world.js`, `trafficSimulator.ts`, `WorldLayersToolbarElement`, `NetworkVisualizer`, `WorldToolbarElement`, `worldGenerator.ts`, `LayoutToolbarElement`, `utils.ts`, `HeatmapGrid`, `AnimationLoopToolbarElement`, `RaceSimulator`?**
