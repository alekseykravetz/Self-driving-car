...
/**
 * Graph-relative anchor for a marking. Stores the authored road segment's
 * endpoints (to re-link after load) plus the marking's position along that
...
export class Marking {
  ...
  // Generated geometry
  support: Segment; // The centerline segment
