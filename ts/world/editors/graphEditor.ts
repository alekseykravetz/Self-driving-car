class GraphEditor {
  ...
  private oneWayHeld: boolean = false;
  private oneWayLatched: boolean = false;

  // Hard-separation mode mirrors one-way: active while 'h' is held OR latched.
  private separatedHeld: boolean = false;
  private separatedLatched: boolean = false;
  private toolbar: ShortcutsToolbarElement | null = null;
