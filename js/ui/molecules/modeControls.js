export class ToolbarModeControls {
    ...
    setTrackingMode(mode) {
        ...
        if (this.#onTrackingModeChange)
            this.#onTrackingModeChange(mode);
    }
    init() {
    ...
    #initBorderModeButtons() {
        ...
        const setActive = (mode) => {
            ...
            if (this.#onBorderModeChange)
                this.#onBorderModeChange(mode);
        };
    ...
    #initViewportModeButtons() {
        ...
        const setActive = (mode) => {
            ...
            if (this.#onViewportModeChange)
                this.#onViewportModeChange(mode);
        };
