...
import { lerp, lerp2D, mulberry32, translate, getFake3dPoint, } from '../../math/utils.js';
...
export const DEFAULT_TREE_PROTOTYPE = buildTreePrototypes(DEFAULT_TREE_SEED, 1)[0];
...
export class Tree {
     ...
     */
    constructor(center, size, prototype = DEFAULT_TREE_PROTOTYPE, prototypeIndex = 0, type = 0, scale = 1, height = 200) {
        this.center = center;
        this.scale = scale;
    ...
    #drawConifer(ctx, viewPoint) {
        ...
        for (let tier = 0; tier < tiers; tier++) {
            ...
            const baseCenter = getFake3dPoint(this.center, viewPoint, this.height * baseT);
