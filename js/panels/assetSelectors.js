...
export class ToolbarAssetSelectors {
    ...
    refreshWorldList() {
        ...
        <label class="asset-item">
          ...
          <span class="asset-item-src">${w.source}</span>
            ...
            .join('');
        list
            .querySelectorAll('input[name="wt-world"]')
            .forEach((radio) => {
            radio.addEventListener('change', () => {
                if (radio.checked)
                    this.#selectWorld(radio.value);
            });
        });
    }
    refreshCarList() {
        ...
        <label class="asset-item">
          ...
          <span class="asset-item-src">${c.source}</span>
            ...
            .join('');
        list
            .querySelectorAll('input[name="wt-car"]')
            .forEach((input) => {
    ...
    #onCarInputChange(input) {
        ...
        this.#updateSelectedDisplay();
        if (this.#onCarsSelected)
            this.#onCarsSelected(mgr.getActiveCars());
    }
    ...
    #bindPicker(buttonId, popoverId) {
        ...
        btn.addEventListener('click', (e) => {
            ...
            this.#host
                .querySelectorAll('.asset-popover')
                .forEach((p) => {
                p.hidden = true;
            });
        ...
        input.addEventListener('change', () => {
            ...
            reader.onload = () => {
                ...
                if (!data) {
                    ...
                    const entry = StoreManager.getInstance()?.addLoadedWorld(file.name, data);
                    this.refreshWorldList();
