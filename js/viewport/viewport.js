...
export class Viewport {
    ...
    mode = 'mouse'; // Wheel behavior (mouse vs. touchpad)
    ...
    drawScaleIndicator(ctx = this.#ctx, viewportWidth = this.canvas.width, viewportHeight = this.canvas.height) {
    ...
    #handleMouseWheel(e) {
        ...
        if (this.mode === 'mouse' || e.ctrlKey) {
            ...
            this.#drag.active = true;
            this.#drag.offset = add(this.#drag.offset, new Point(-e.deltaX * this.zoom, -e.deltaY * this.zoom));
